...
class PrivilegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create privilege" do
    assert_difference('Privilege.count') do
      post privileges_url, params: { privilege: { name: @privilege.name, role_id: @privilege.role_id } }
    end
  ...
  test "should update privilege" do
    patch privilege_url(@privilege), params: { privilege: { name: @privilege.name, role_id: @privilege.role_id } }
